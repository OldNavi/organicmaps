...
std::string_view constexpr allow3dBuildingsKey = "Buildings3d";
...
void Framework::Save3dMode(bool allow3d, bool allow3dBuildings)
{
  ...
  settings::Set(allow3dBuildingsKey, allow3dBuildings);
}
...
void Framework::Load3dMode(bool & allow3d, bool & allow3dBuildings)
{
  ...
  if (!settings::Get(allow3dBuildingsKey, allow3dBuildings))
